...
export const Navbar = () => {
  ...
  return (
    <HeroUINavbar 
      ...
      className="border-b border-default-200 dark:border-default-100 shadow-sm"
    >
      <NavbarContent>
        <NavbarMenuToggle
        ...
        <NavbarBrand as="li" className="gap-3 max-w-fit">
          <NextLink className="flex justify-start items-center gap-2 hover:opacity-80 transition-opacity" href="/">
            ...
            <p className="font-bold text-inherit text-lg">Airbnb Reservation</p>
          </NextLink>
        </NavbarBrand>
      </NavbarContent>
      ...
      >
        <NavbarItem className="hidden sm:flex gap-2">
          ...
          <NextLink href="/reservations">
            <Button variant="flat" size="sm" className="font-medium">
              <svg
        ...
        {authenticated && (
          <>
            ...
            <NavbarMenuItem>
              ...
              >
                <Button variant="flat" className="w-full justify-start font-medium" startContent={
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
            ...
            <NavbarMenuItem>
              <div className="flex items-center justify-between w-full py-2 px-3 rounded-lg bg-default-50 dark:bg-default-100">
